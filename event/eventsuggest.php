...
{
  $query = "INSERT INTO `suggested_event` (`id`, `nom_event`, `date_event`, `summary_event`) VALUES (NULL, '".$_POST['eventName']."', '".$_POST['eventDate']."', '".$_POST['eventSum']."');";

   $DB->insert($query);?>
    <h2>Evenement Soumis au BDE! :)</h2>
<?php
}
?>
...
<div class="container">
    ...
    <div class="regisFrm">
        <form action="eventsuggest.php" method="post">
