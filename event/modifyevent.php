...
?>
  ...
  <body>
    ...
    <header class="">
      ...
      <?php
       $events = $DB->query("SELECT * FROM event WHERE id =" .$_GET['idevent']);
    if(isset($_POST['sendSubmit']))
    {
       ...
       move_uploaded_file($_FILES['eventImg']['tmp_name'], $dossier . $fichier); 
        ...
        $query =  "UPDATE event SET nom_event = '".$_POST['eventName']."', date_event = '".$_POST['eventDate']."', resume_event = \"".$_POST['eventSum']."\" , prix_event = '".$_POST['eventPrice']."', img_event = '".$_FILES['eventImg']['name']."' WHERE id = ".$_GET['idevent'];
    ...
    ?>
          ...
          <div class="container">
            ...
            <div class="regisFrm">
              <form enctype="multipart/form-data" action="modifyevent.php?idevent=<?php echo $_GET['idevent'] ?>" method="post">
