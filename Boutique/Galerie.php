...
<head>
    ...
    <title>Galerie BDE EXIA </title>

    <link rel="stylesheet" href="bootstrap.min.css">
              <link rel="stylesheet" href="bootstrap.css">
              <link rel="stylesheet" href="business-frontpage.css">
...
?>
  ...
  <br>
        ...
        <h2>Event Constantine</h2>
  <div class="gallery cf">
      <?php $products = $DB->query('SELECT * FROM Images'); ?>
      <?php foreach ($products as $image ) : ?>  
        
  <div >
    <img   src="Images/<?php echo $image->id; ?>.jpg" alt="Item<?php echo $image->name; ?>">
  </div>
