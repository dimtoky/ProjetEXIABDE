...
?>
  ...
  <body>
    ...
    <header class="">
      ...
      <div id="currentevent" class="panel panel-default" style="background-color:#f2f2f2">


        <h2>Evenement en cours</h2>

        <div class="row">
          <div class="col-sm-4" class="panel panel-default">
            <div class="thumbnail">
              <img src="hal.jpg" alt="Generic placeholder thumbnail">
            </div>

            <div class="caption">
              <h3>Halloween Party</h3>
              <p>Venez vivre l'evenement Halloween</p>
      ...
      <div id="nextevent" class="panel panel-default">
